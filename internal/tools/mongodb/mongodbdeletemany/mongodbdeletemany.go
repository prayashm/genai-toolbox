...
func (cfg Config) Initialize(srcs map[string]sources.Source) (tools.Tool, error) {
	...
	if cfg.Collection == "" {
		collectionParam := tools.NewStringParameterWithRequired("collection", "The name of the collection to delete from", true)
...
func (t Tool) Invoke(ctx context.Context, params tools.ParamValues, accessToken tools.AccessToken) (any, error) {
	...
	res, err := t.database.Collection(collectionName).DeleteMany(ctx, filter, opts)
	if err != nil {
		return nil, err
	}
